cd /home/varun/Desktop/ell_project/inputimages3
pkg load image
...
for i = 1:size(images,1)
  I = imread(sprintf('inputimages3/%s',images{i}));
  ...
  [J, alpha, beta, gamma, minInt, maxInt, m, s] = optimalEqualize(I);
	...
	print(1, '-djpg',sprintf('experiments7/%d_1.jpg', i));
	close;
	[counts, x] = imhist(J);
	stem(x, counts, 'k');
	title('final histogram');
	print(1, '-djpg',sprintf('experiments7/%d_2.jpg', i));
	close;
	imwrite(I, sprintf('experiments7/%d_3.jpg', i));
	imwrite(J, sprintf('experiments7/%d_4.jpg', i));
	printf('DONE!\n');
endfor